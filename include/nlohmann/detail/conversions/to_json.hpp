...
struct external_constructor<value_t::boolean>
{
    ...
    {
        j.m_value.destroy(j.m_type, j.m_mem_resource);
...
struct external_constructor<value_t::string>
{
    ...
    static void construct(BasicJsonType& j, const typename BasicJsonType::string_t& s)
    {
        ...
        j.m_value = typename BasicJsonType::json_value{s, j.m_mem_resource};
        j.assert_invariant();
    }
    ...
    static void construct(BasicJsonType& j, typename BasicJsonType::string_t&& s)
    {
        j.m_value.destroy(j.m_type, j.m_mem_resource);
        j.m_type = value_t::string;
        j.m_value = typename BasicJsonType::json_value{std::move(s), j.m_mem_resource};
        j.assert_invariant();
    }
...
struct external_constructor<value_t::binary>
{
    ...
    static void construct(BasicJsonType& j, const typename BasicJsonType::binary_t& b)
    {
        ...
        j.m_value = typename BasicJsonType::json_value{typename BasicJsonType::binary_t(b), j.m_mem_resource};
        j.assert_invariant();
    }
    ...
    static void construct(BasicJsonType& j, typename BasicJsonType::binary_t&& b)
    {
        j.m_value.destroy(j.m_type, j.m_mem_resource);
        j.m_type = value_t::binary;
        j.m_value = typename BasicJsonType::json_value{typename BasicJsonType::binary_t(std::move(b)), j.m_mem_resource};
        j.assert_invariant();
    }
};
...
struct external_constructor<value_t::array>
{
    ...
    static void construct(BasicJsonType& j, const typename BasicJsonType::array_t& arr)
    {
        ...
        j.m_value = typename BasicJsonType::json_value{arr, j.m_mem_resource};
        j.set_parents();
        j.assert_invariant();
    }
    ...
    static void construct(BasicJsonType& j, typename BasicJsonType::array_t&& arr)
    {
        j.m_value.destroy(j.m_type, j.m_mem_resource);
        j.m_type = value_t::array;
        j.m_value = typename BasicJsonType::json_value{std::move(arr), j.m_mem_resource};
        j.set_parents();
        j.assert_invariant();
    }
    ...
    static void construct(BasicJsonType& j, const std::vector<bool>& arr)
    {
        j.m_value.destroy(j.m_type, j.m_mem_resource);
        j.m_type = value_t::array;
        j.m_value = typename BasicJsonType::json_value{value_t::array, j.m_mem_resource};
...
struct external_constructor<value_t::object>
{
    ...
    static void construct(BasicJsonType& j, const typename BasicJsonType::object_t& obj)
    {
        ...
        j.m_value = typename BasicJsonType::json_value{obj, j.m_mem_resource};
        j.set_parents();
        j.assert_invariant();
    }
    ...
    static void construct(BasicJsonType& j, typename BasicJsonType::object_t&& obj)
    {
        j.m_value.destroy(j.m_type, j.m_mem_resource);
        j.m_type = value_t::object;
        j.m_value = typename BasicJsonType::json_value{std::move(obj), j.m_mem_resource};
        j.set_parents();
        j.assert_invariant();
    }
